...
SemiAutoControl::SemiAutoControl(uint8_t controlPinNumber, bool hasExternalPullup, uint8_t ledPinNumber)
{
  _buttonPin = new Input(controlPinNumber, hasExternalPullup);
...
void SemiAutoControl::setManualOff()
{
  _manualIsHigh = false;
  updateOutput();
}
...
{
  return _autoIsHigh || _manualIsHigh;
}
